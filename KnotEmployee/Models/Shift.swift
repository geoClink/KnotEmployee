...
struct Shift: Identifiable, Hashable {
    ...
    init(id: UUID = UUID(), day: String, date: String, start: String, end: String,
         role: String, note: String? = nil, breakLabel: String? = nil,
         status: Status = .scheduled) {
        self.id = id; self.day = day; self.date = date
